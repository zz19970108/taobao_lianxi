...
public class CartAdapter extends BaseExpandableListAdapter{
    ...
    private List<List<CartBean.DataBean.ListBean>> listChild;

    public CartAdapter(Context context, List<CartBean.DataBean> listGroup, List<List<CartBean.DataBean.ListBean>> listChild, Handler handler) {
    ...
    private void changeChildState(int groupPosition, boolean groupChecked) {
        List<CartBean.DataBean.ListBean> listBeans = listChild.get(groupPosition);
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean b, View view, ViewGroup viewGroup) {
        ...
        //赋值
        final CartBean.DataBean.ListBean listBean = listChild.get(groupPosition).get(childPosition);
